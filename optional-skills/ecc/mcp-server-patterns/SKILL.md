...
description: "Build MCP servers with Node/TypeScript SDK — tools, resources, prompts, Zod validation, stdio vs Streamable HTTP transport. Use Context7 or official MCP docs for latest API."
version: 1.0.0
...
metadata:
  hermes:
    tags: [mcp, typescript, server, tools, resources]
    related_skills: [search-first, verification-loop]
    homepage: https://modelcontextprotocol.io/
  upstream: https://github.com/YeLuo45/ECC
  upstream_skill_path: skills/mcp-server-patterns/SKILL.md
prerequisites:
  commands: []
---

> **Origin**: Cherry-picked from [https://github.com/YeLuo45/ECC](https://github.com/YeLuo45/ECC/blob/main/skills/mcp-server-patterns/SKILL.md) (commit `main`). Updated to hermes-native frontmatter; body content preserved verbatim from upstream.
