---
name: search-first
description: "Research-first development — before writing code, search official docs, RFCs, GitHub issues, and prior art to avoid reinventing. Use for non-trivial implementation choices, library selection, and architectural decisions."
version: 1.0.0
...
metadata:
  hermes:
    tags: [research, search-first, documentation, best-practices]
    related_skills: [iterative-retrieval, mcp-server-patterns]
  upstream: https://github.com/YeLuo45/ECC
  upstream_skill_path: skills/search-first/SKILL.md
prerequisites:
  commands: []
---

> **Origin**: Cherry-picked from [https://github.com/YeLuo45/ECC](https://github.com/YeLuo45/ECC/blob/main/skills/search-first/SKILL.md) (commit `main`). Updated to hermes-native frontmatter; body content preserved verbatim from upstream.
