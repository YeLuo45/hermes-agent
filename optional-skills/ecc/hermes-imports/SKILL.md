...
metadata:
  hermes:
    tags: [hermes, ecc, migration, sanitization, operator]
    related_skills: [verification-loop, tdd-workflow]
    homepage: https://github.com/YeLuo45/ECC/blob/main/docs/HERMES-OPENCLAW-MIGRATION.md
  upstream: https://github.com/YeLuo45/ECC
  upstream_skill_path: skills/hermes-imports/SKILL.md
prerequisites:
  commands: []
---

> **Origin**: Cherry-picked from [https://github.com/YeLuo45/ECC](https://github.com/YeLuo45/ECC/blob/main/skills/hermes-imports/SKILL.md) (commit `main`). Updated to hermes-native frontmatter; body content preserved verbatim from upstream.
